...
import type { Shop, Booth, Booking } from '../../types';
import { LocationIcon, StarIcon, SearchIcon, PriceIcon, DirectionsIcon } from '../shared/Icons';
...
const ShopCard: React.FC<ShopCardProps> = ({ shop, onShopClick, onGetDirections }) => {
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-auto space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <button onClick={() => onShopClick(shop)} className="w-full bg-brand-primary text-white font-bold py-2 px-3 rounded-lg hover:bg-opacity-80 transition-colors text-sm">
                            View Details
                        </button>
                    </div>
                </div>
...
export const ArtistSearchView: React.FC<ArtistSearchViewProps> = ({ shops, onShopClick, onGetDirections, userLocation, getLocation, isGettingLocation }) => {
    ...
    }, [shops, searchTerm, locationFilter]);
        ...
        <div className="space-y-8">
            <div className="bg-gray-900/50 rounded-2xl p-4 md:p-6 border border-gray-800 backdrop-blur-sm">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-end">
                    ...
                    <div className="lg:col-span-1">
                     ...
                     <div className="lg:col-span-1">
                        <button onClick={getLocation} disabled={isGettingLocation} className="w-full bg-brand-secondary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center space-x-2 disabled:bg-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredShops.map(shop => (
                    <ShopCard key={shop.id} shop={shop} onShopClick={onShopClick} onGetDirections={onGetDirections} />
                ))}
            </div>
